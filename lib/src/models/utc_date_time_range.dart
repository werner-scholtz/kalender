...
//   }) : super(
//           start: DateTime.fromMicrosecondsSinceEpoch(range.start.microsecondsSinceEpoch, isUtc: true),
//           end: DateTime.fromMicrosecondsSinceEpoch(range.end.microsecondsSinceEpoch, isUtc: true),
//         );
...
//     } else {
//       return DateTimeRange(start: startToLocal(location), end: endToLocal(location));
//     }
//   }
