...
class WeekDayHeaderStyle with Diagnosticable {
  const WeekDayHeaderStyle({this.textStyle, this.padding});
  ...
  WeekDayHeaderStyle copyWith({TextStyle? textStyle, EdgeInsets? padding}) {
    return WeekDayHeaderStyle(textStyle: textStyle ?? this.textStyle, padding: padding ?? this.padding);
  }
  ...
  WeekDayHeaderStyle merge(WeekDayHeaderStyle? other) {
    ...
    return WeekDayHeaderStyle(textStyle: other.textStyle ?? textStyle, padding: other.padding ?? padding);
  }
...
class WeekDayHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: padding,
      child: Center(child: Text(dateText, style: style.textStyle)),
    );
  }
}
