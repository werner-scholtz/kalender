...
- The month view's day number is smaller and floats clear of the gridline above and the event tiles below, so the today highlight no longer looks cramped. [#320](https://github.com/werner-scholtz/kalender/pull/320)
