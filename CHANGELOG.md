...
- `TileComponents.overlayTileBuilder` is used again by the tiles in the multi-day overflow overlay. It has been ignored since 0.14.0, so the overlay rendered `tileBuilder` instead.
