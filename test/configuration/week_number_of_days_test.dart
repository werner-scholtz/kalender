...
void main() {
  ...
  group('MultiDayViewConfiguration.week', () {
    test('a page is numberOfDays long and still turns a week at a time', () {
      ...
      final page = calculator.rangeFromIndex(index, null);
      final next = calculator.rangeFromIndex(index + 1, null);
    ...
    test('the default is still a full week', () {
      ...
      final calculator = configuration.pageIndexCalculator;
      final page = calculator.rangeFromIndex(calculator.indexFromDate(monday, null), null);
    ...
    test('copyWith keeps numberOfDays and replaces it', () {
      ...
      final page = replaced.pageIndexCalculator.rangeFromIndex(
