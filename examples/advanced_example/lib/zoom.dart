...
import 'package:kalender/kalender_providers.dart';

class ZoomDetector extends StatelessWidget {
  final Widget child;
  const ZoomDetector({super.key, required this.child});

  @override
  Widget build(BuildContext context) {
    return switch (defaultTargetPlatform) {
      TargetPlatform.iOS || TargetPlatform.android => MobileZoomDetector(child: child),
      _ => DesktopZoomDetector(child: child),
    };
  }
}
...
class DesktopZoomDetector extends StatefulWidget {
  final Widget child;
  const DesktopZoomDetector({super.key, required this.child});
...
class _DesktopZoomDetectorState extends State<DesktopZoomDetector> with ZoomUtils {
  @override
  CalendarController<Object?> get controller => context.calendarController<Event>();
...
class MobileZoomDetector extends StatefulWidget {
  ...
  const MobileZoomDetector({super.key, required this.child});
