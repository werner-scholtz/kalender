...
class WorkWeekConfiguarionEditor extends StatelessWidget {
  const WorkWeekConfiguarionEditor({
    super.key,
    required this.config,
    required this.onConfigChanged,
  });

  final WorkWeekConfiguration config;
  final void Function(WorkWeekConfiguration newConfig) onConfigChanged;
